...
const WillAddDrawer = ({ onClose }) => {
  ...
  useEffect(() => {
    ...
    switch (willWhat) {
      ...
      case 5:
        setWillList(
          unknownSentencesWillAdd.filter(
            (element) =>
              latinize(element.sentence).toLowerCase().indexOf(queryLatinized) >
              -1
          )
  ...
  const willLength = (key) => {
    switch (key) {
      case 0:
        return wordsWillAdd.length;
      case 1:
        return phrasesWillAdd.length;
      case 2:
        return sentencesWillAdd.length;
      case 3:
        return unknownWordsWillAdd.length;
      case 4:
        return unknownPhrasesWillAdd.length;
      case 5:
        return unknownSentencesWillAdd.length;
      default:
        return 0;
    }
  };
    ...
    <>
      ...
      >
        <section className={styles.header}>
          <h2 className={styles.title}>Will Add</h2>
