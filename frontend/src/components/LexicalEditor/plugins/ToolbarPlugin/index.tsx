...
function InsertGifUriDialogBody({
  onClick,
}: {
  ...
  return (
    <>
      <TextInput
        label="Image URL"
        placeholder="i.e. https://tenor.com/"
        onChange={setSrc}
        value={src}
...
function InsertGifDialog({
  ...
  return (
    <>
      ...
      {mode === "url" && <InsertGifUriDialogBody onClick={onClick} />}
      {/* {mode === "file" && <InsertGifUploadedDialogBody onClick={onClick} />} */}
    </>
  );
}
